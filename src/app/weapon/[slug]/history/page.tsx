...
export default async function WeaponHistoryPage({ params }: { params: Promise<{ slug: string }> }) {
  const { slug } = await params;

  // Fetch videos for this weapon
  ...
  const lifecycle = await TrendingService.getMetaLifecycleStatus(slug, "weapons");
    ...
    <AppLayout>
      <div className="max-w-4xl mx-auto space-y-8 mt-10">
        <div className="border-b border-gray-800 pb-6">
          <div className="text-[10px] font-mono text-cyan-500 tracking-widest mb-2 uppercase">Meta Evolution Tracking</div>
              ...
              <div>
                ...
                {event.type === "video" ? (
                  <div className="flex gap-4 items-start bg-gray-900/30 border border-gray-800/50 p-4">
                    <PlaySquare className="w-5 h-5 text-cyan-400 flex-shrink-0 mt-0.5" />
                    <div>
